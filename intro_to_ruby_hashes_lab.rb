...
def monopoly_with_fourth_tier
  ...
  monopoly[:railroads][:pennsylvania_railroad][:one_piece_owned] = {}
  monopoly[:railroads][:b_and_o_railroad][:two_pieces_owned] = {}
  monopoly[:railroads][:shortline][:three_pieces_owned] = {}
